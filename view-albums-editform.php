...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editAlbumModal<?php echo $album['album_id'];?>">
...
<div class="modal fade" id="editAlbumModal<?php echo $album['album_id'];?>" tabindex="-1" aria-labelledby="editAlbumModalLabel<?php echo $album['album_id'];?>" aria-hidden="true">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="aTitle<?php echo $album['album_id'];?>" name="aTitle" value = "<?php echo $album['album_title'];?>">
  </div>
   <div class="mb-3">
