...
<input type="text" class="form-control" id = "aTitle" name = "aTitle"> 
   ...
   <div class="mb-3">
    <label for="aOnHand" class="form-label">Albums on Hand</label>
     <input type = "text" class = "form-control" id = "aOnHand" name = "aOnHand"/>
  </div>
     <div class="mb-3">
    <label for="aPrice" class="form-label">Price</label>
     <input type = "text" class = "form-control" id = "aPrice" name = "aPrice"/>
  </div>
  <div class="mb-3">
    <label for="aYear" class="form-label">Release Years</label>
